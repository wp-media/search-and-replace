...
?>
	...
	<p><?php printf(
			__( 'You can contribute the Plugin go to the repository on <a href="%s">github</a> making changes, creating issues, or submitting changes.', 'search-and-replace' ),
			'https://github.com/inpsyde/search-and-replace/'
		); ?></p>

	<h2><?php esc_html_e( 'We are Inpsyde', 'search-and-replace' ); ?></h2>
	<p><?php esc_html_e( 'Inpsyde has developed enterprise solutions with the world’s most popular open-source CMS ever since it was a kitten. We still do, inconvincibly convinced.', 'search-and-replace' ); ?></p>
	<p><?php printf(
	...
	<p><?php esc_html_e( 'As the biggest WordPress enterprise in Europe, we’re dynamically growing and constantly looking for new employees. So, do you want to shape WordPress in an interesting and exciting work environment? Here we are!', 'search-and-replace' ); ?> </p>
	...
	<p><?php printf(
			__( 'If you love open source and especially WordPress, if you love to organize your working days by yourself, and you want to use your pragmatic problem-solving skills and result-oriented work methods: <a href="%s">join our team</a>!', 'search-and-replace' ),
