...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a class="nav-tab " href="<?php echo admin_url() ?>tools.php?page=replace_domain"><?php esc_html_e( 'Replace Domain/URL', 'search-and-replace' ); ?></a>
		<a class="nav-tab nav-tab-active" href="<?php echo admin_url() ?>tools.php?page=inpsyde_search_replace">
			<?php esc_html_e( 'Search and Replace', 'search-and-replace' ); ?></a>
